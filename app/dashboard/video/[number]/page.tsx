...
export default function VideoDashboardNumberPage({
  params,
}: {
  ...
  const skip: number = Math.abs((Number(params.number || 0) - 1) * 6);

  function getVideos() {
    axios
      .get(`/api/all-card?take=${6}&skip=${skip}`, {
        headers: {
          "api-key": APIKEY,
        },
      })
      ...
      >
        ...
        >
          <Pagination
            ...
            currentPage={Number(params.number || 1)}
